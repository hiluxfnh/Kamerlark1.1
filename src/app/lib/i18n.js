...
const translations = {
  en: {
    ...
    "community.subtitle":
      "Find a roommate, sublet a room, or ask the locals — then message them in one tap.",
    "community.feed": "Feed",
    ...
    "community.markTaken": "Mark as taken",
    "community.markAvailable": "Mark available",
    "community.takenBadge": "Taken",
    // Marketplace (dedicated page)
    "market.title": "Marketplace",
    "market.subtitle": "Buy, sell, swap or give away with students near you.",
    "market.sell": "List an item",
    "market.whatSelling": "What are you selling or giving away? Describe the item and its condition.",
    "market.priceOptional": "Price (e.g. 5000 XAF — leave empty for free)",
    "market.pickupOptional": "Pickup area (optional)",
    "market.post": "Post item",
    "market.posting": "Posting…",
    "market.empty": "No items yet",
    "market.beFirst": "Be the first to list something for sale or to give away.",
    "market.availableOnly": "Available only",
    "market.free": "Free",
    "market.loginToPost": "Sign in to buy and sell on the marketplace.",
    "market.postError": "Couldn't post your item. Please try again.",
    // Roommate
    "roommate.lookingTitle": "Looking for a roommate",
    "roommate.lookingHint": "Show other students you're open to sharing a place.",
    "roommate.lookingBadge": "Looking for a roommate",
    "roommate.sendRequest": "Roommate request",
    "roommate.requested": "Requested",
    "roommate.requestSent": "Roommate request sent",
    "roommate.requestError": "Couldn't send the request. Please try again.",
    "roommate.incomingTitle": "Roommate requests",
    "roommate.wantsToRoom": "wants to be your roommate",
    "roommate.accept": "Accept",
    "roommate.decline": "Decline",
    "roommate.accepted": "Accepted",
    "roommate.declined": "Declined",
    ...
    "notif.hint": "Get a desktop alert when you receive a new message (while KamerLark is open).",
    "notif.newMessage": "New message",
    "notif.newMessageBody": "You have a new message on KamerLark.",
    // Chat
    ...
    // Appointment cards
    "appt.incoming": "Incoming",
    "appt.outgoing": "Outgoing",
    "appt.userName": "User Name",
    "appt.status": "Status",
    "appt.email": "Email",
    "appt.phone": "Phone",
    ...
    "appt.viewRoom": "VIEW ROOM DETAILS",
    "appt.cancel": "CANCEL",
    "appt.chat": "CHAT",
    ...
    "booking.moveInDate": "Move In Date",
    ...
    "booking.price": "Price:",
    "booking.submitReviewOn": "Submit Your Review on",
    "booking.reviewLabel": "Review",
    "booking.close": "close",
    "booking.signInReview": "You must be signed in to submit a review",
    "booking.ratingRequired": "Rating and review are required",
    "booking.reviewSubmitted": "Review submitted",
    "booking.reviewFailed": "Failed to submit review",
    "booking.viewUserProfile": "View User Profile",
    "booking.roomDetails": "Room Details",
    "booking.chatWithUser": "Chat with User",
    ...
    "account.detailsAbout": "Details about your account.",
    ...
    "account.tabPassword": "Change Password",
    "account.tabDelete": "Delete Account",
    "account.updatePersonal": "Update Personal Information",
    ...
    "account.deleteWarning": "Warning: This action cannot be undone.",
    "account.confirmDeletion": "Confirm account deletion",
    "account.enterPasswordConfirm":
      "Please enter your current password to confirm account deletion.",
    "account.delete": "Delete",
    "account.photoUpdated": "Profile photo updated",
    "account.photoFailed": "Failed to upload photo",
    "account.emailUpdateFailed": "Email update failed; recent login required",
    "account.personalUpdated": "Personal information updated",
    "account.personalError": "Error updating personal information",
    "account.passwordMismatch": "New password and confirm password do not match",
    "account.passwordUpdated": "Password updated successfully",
    "account.passwordError": "Error updating password. Please check current password.",
    "account.accountDeleted": "Account deleted",
    "account.deleteFailed": "Failed to delete account",
    // My listing page
    "mylisting.myBookings": "My Bookings",
    "mylisting.noBookings": "No bookings found.",
    "mylisting.myProperties": "My Properties",
    "mylisting.noProperties": "No properties found.",
    "mylisting.nameLabel": "Name:",
    "mylisting.descLabel": "Description:",
    "mylisting.save": "Save",
    "mylisting.bookingDetails": "Booking Details",
    // Login prompt modal
    "prompt.title": "Please Log In",
    "prompt.body": "You need to log in to access this page.",
    "prompt.close": "Close",
    // Public profile
    "pubprofile.loading": "Loading profile…",
    "pubprofile.notFound": "Profile not found.",
    "pubprofile.message": "Message",
    "pubprofile.followers": "Followers",
    "pubprofile.followingCount": "Following",
    "pubprofile.listings": "Listings",
    "pubprofile.about": "About",
    "pubprofile.noBio": "No bio provided.",
    "pubprofile.emailLabel": "Email: ",
    "pubprofile.phoneLabel": "Phone: ",
    "pubprofile.highlights": "Highlights",
    "pubprofile.studiesAt": "Studies/Studied at",
    "pubprofile.basedIn": "Based in",
    "pubprofile.has": "Has",
    "pubprofile.activeListing": "active listing",
    "pubprofile.activeListings": "active listings",
  ...
  fr: {
    ...
    "community.subtitle":
      "Trouvez un colocataire, sous-louez une chambre ou demandez aux locaux — puis contactez-les en un clic.",
    "community.feed": "Fil",
    ...
    "community.markTaken": "Marquer comme pris",
    "community.markAvailable": "Marquer disponible",
    "community.takenBadge": "Pris",
    // Marketplace (dedicated page)
    "market.title": "Marché",
    "market.subtitle": "Achetez, vendez, échangez ou donnez entre étudiants près de chez vous.",
    "market.sell": "Publier un article",
    "market.whatSelling": "Que vendez-vous ou donnez-vous ? Décrivez l'article et son état.",
    "market.priceOptional": "Prix (ex. 5000 XAF — laissez vide si gratuit)",
    "market.pickupOptional": "Lieu de retrait (facultatif)",
    "market.post": "Publier l'article",
    "market.posting": "Publication…",
    "market.empty": "Aucun article pour l'instant",
    "market.beFirst": "Soyez le premier à publier un article à vendre ou à donner.",
    "market.availableOnly": "Disponibles uniquement",
    "market.free": "Gratuit",
    "market.loginToPost": "Connectez-vous pour acheter et vendre sur le marché.",
    "market.postError": "Impossible de publier votre article. Veuillez réessayer.",
    // Roommate
    "roommate.lookingTitle": "Recherche un colocataire",
    "roommate.lookingHint": "Indiquez aux autres étudiants que vous êtes ouvert à la colocation.",
    "roommate.lookingBadge": "Cherche un colocataire",
    "roommate.sendRequest": "Demande de colocation",
    "roommate.requested": "Demande envoyée",
    "roommate.requestSent": "Demande de colocation envoyée",
    "roommate.requestError": "Impossible d'envoyer la demande. Veuillez réessayer.",
    "roommate.incomingTitle": "Demandes de colocation",
    "roommate.wantsToRoom": "souhaite être votre colocataire",
    "roommate.accept": "Accepter",
    "roommate.decline": "Refuser",
    "roommate.accepted": "Acceptée",
    "roommate.declined": "Refusée",
    // Device notifications
    "notif.enable": "Activer les notifications",
    "notif.enabled": "Notifications activées",
    "notif.blocked": "Les notifications sont bloquées dans les paramètres de votre navigateur.",
    "notif.hint": "Recevez une alerte sur votre appareil à chaque nouveau message (lorsque KamerLark est ouvert).",
    "notif.newMessage": "Nouveau message",
    "notif.newMessageBody": "Vous avez un nouveau message sur KamerLark.",
    // Chat
    ...
    // Appointment cards
    "appt.incoming": "Reçus",
    "appt.outgoing": "Envoyés",
    "appt.userName": "Nom d'utilisateur",
    "appt.status": "Statut",
    "appt.email": "E-mail",
    "appt.phone": "Téléphone",
    "appt.dateTime": "Date & heure",
    "appt.at": "à",
    "appt.type": "Type de rendez-vous",
    "appt.message": "Message",
    "appt.viewRoom": "VOIR LES DÉTAILS",
    "appt.cancel": "ANNULER",
    "appt.chat": "DISCUTER",
    "appt.decline": "Refuser",
    "appt.accept": "Accepter",
    // Booking cards
    "booking.userName": "Nom d'utilisateur",
    "booking.userEmail": "E-mail de l'utilisateur",
    "booking.moveInDate": "Date d'emménagement",
    "booking.phoneNumber": "Numéro de téléphone",
    "booking.userAddress": "Adresse de l'utilisateur",
    "booking.notes": "Notes",
    "booking.contract": "Contrat",
    "booking.statusLabel": "Statut :",
    "booking.viewDetails": "Voir les détails",
    "booking.chat": "Discuter",
    "booking.review": "Évaluer",
    "booking.cancel": "Annuler",
    "booking.price": "Prix :",
    "booking.submitReviewOn": "Laissez votre avis sur",
    "booking.reviewLabel": "Avis",
    "booking.close": "fermer",
    "booking.signInReview": "Vous devez être connecté pour laisser un avis",
    "booking.ratingRequired": "La note et l'avis sont obligatoires",
    "booking.reviewSubmitted": "Avis envoyé",
    "booking.reviewFailed": "Échec de l'envoi de l'avis",
    "booking.viewUserProfile": "Voir le profil",
    "booking.roomDetails": "Détails du logement",
    "booking.chatWithUser": "Discuter avec l'utilisateur",
    ...
    "account.detailsAbout": "Détails de votre compte.",
    "account.fullName": "Nom complet",
    "account.emailAddress": "Adresse e-mail",
    "account.phoneNumberLabel": "Numéro de téléphone",
    "account.addressLabel": "Adresse",
    "account.tabPassword": "Changer le mot de passe",
    "account.tabDelete": "Supprimer le compte",
    "account.updatePersonal": "Mettre à jour les informations personnelles",
    ...
    "account.deleteWarning": "Attention : cette action est irréversible.",
    "account.confirmDeletion": "Confirmer la suppression du compte",
    "account.enterPasswordConfirm":
      "Veuillez saisir votre mot de passe actuel pour confirmer la suppression du compte.",
    "account.delete": "Supprimer",
    "account.photoUpdated": "Photo de profil mise à jour",
    "account.photoFailed": "Échec du téléversement de la photo",
    "account.emailUpdateFailed":
      "Échec de la mise à jour de l'e-mail ; une connexion récente est requise",
    "account.personalUpdated": "Informations personnelles mises à jour",
    "account.personalError": "Erreur lors de la mise à jour des informations",
    "account.passwordMismatch":
      "Le nouveau mot de passe et la confirmation ne correspondent pas",
    "account.passwordUpdated": "Mot de passe mis à jour avec succès",
    "account.passwordError":
      "Erreur lors de la mise à jour du mot de passe. Vérifiez le mot de passe actuel.",
    "account.accountDeleted": "Compte supprimé",
    "account.deleteFailed": "Échec de la suppression du compte",
    // My listing page
    "mylisting.myBookings": "Mes réservations",
    "mylisting.noBookings": "Aucune réservation trouvée.",
    "mylisting.myProperties": "Mes logements",
    "mylisting.noProperties": "Aucun logement trouvé.",
    "mylisting.nameLabel": "Nom :",
    "mylisting.descLabel": "Description :",
    "mylisting.save": "Enregistrer",
    "mylisting.bookingDetails": "Détails de la réservation",
    // Login prompt modal
    "prompt.title": "Veuillez vous connecter",
    "prompt.body": "Vous devez vous connecter pour accéder à cette page.",
    "prompt.close": "Fermer",
    // Public profile
    "pubprofile.loading": "Chargement du profil…",
    "pubprofile.notFound": "Profil introuvable.",
    "pubprofile.message": "Message",
    "pubprofile.followers": "Abonnés",
    "pubprofile.followingCount": "Abonnements",
    "pubprofile.listings": "Annonces",
    "pubprofile.about": "À propos",
    "pubprofile.noBio": "Aucune bio fournie.",
    "pubprofile.emailLabel": "E-mail : ",
    "pubprofile.phoneLabel": "Téléphone : ",
    "pubprofile.highlights": "Points forts",
    "pubprofile.studiesAt": "Étudie / a étudié à",
    "pubprofile.basedIn": "Basé à",
    "pubprofile.has": "A",
    "pubprofile.activeListing": "annonce active",
    "pubprofile.activeListings": "annonces actives",
